...
public class AddToExhibition extends JDialog
{

    private static AddToExhibition instance;
    TablePanel tablePanel;
    private ArrayList<Long> ids;
    private JLabel exhibitCount;
    private JComboBox<String> comboBox;
    private ComboBoxModel<String> comboBoxModel;
    ArrayList<Long> vectorLong = new ArrayList<Long>();
    ArrayList<String> vectorString = new ArrayList<String>();
    ArrayList<Outsourced> list;
     ...
     * @param id
     */
    public AddToExhibition(long id)
    {
        instance = this;
        ...
        }
        {
            ...
            getContentPane().add(exhibitCount, "cell 1 0,alignx left");
        }
        {
            JLabel lblErstelleEineNeue = new JLabel(
                    "Erstelle eine neue Ausstellung");
            getContentPane().add(lblErstelleEineNeue, "cell 0 2");
        }
        {
            JLabel lblNewLabel = new JLabel("Wähle eine Ausstellung");
            getContentPane().add(lblNewLabel, "cell 0 1,alignx left");
        }
        {
            {
                comboBox = new JComboBox<String>();
                comboBoxModel = new DefaultComboBoxModel<String>(getLists());
            ...
            btnNeueLeihgabeErstellen.addActionListener(new ActionListener()
            {
                public void actionPerformed(ActionEvent e)
                {
                    CreateExhibition createExhibition = new CreateExhibition(
                            true);
                    createExhibition.setVisible(true);
                }
            });
        ...
        }
        {
            ...
            {
                JButton okButton = new JButton("Ausstellen");
                    ...
                    public void actionPerformed(ActionEvent e)
                    {
                        if (comboBox.getItemCount() == 0)
                        {
                            JOptionPane.showMessageDialog(null,
                                    "Noch keine Ausstellung vorhanden!",
                                    "Keine Ausstellung",
                        ...
                        else
                        {
                                    ...
                                    try
                                    {
                                        ...
                                        if (outsourcedFound != null)
                                        {
                                            int reply = JOptionPane
                                                    ...
                                                    + " zugeordnet.\nMöchten Sie es dennoch einer anderen Ausstellung hinzufügen?",
                                                    "Exponat anderer Ausstellung hinzufügen",
                                        ...
                                        Access.addToExhibition(actual,
                                                vectorLong.get(comboBox
                                                .getSelectedIndex()));
                                        InformationPanel
                                                .getInstance()
                                                .setText(
                                                "Exponat(e) erfolgreich zur Ausstellung hinzugefügt");
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    if (add)
                                    {
                                        Access.addToExhibition(tablePanel
    ...
    /**
     * Insert data to two different vectors
     *
     * @return
     */
    public String[] getLists()
    {
        try
        {
            list = Access.getAllExhibitionsByMuseum(TreeMainPanel.getInstance()
                    .getMuseumId());
        }
    ...
    /**
     * Clears the vectors, and refreshes the Combobox
     *
     */
    public void refresh()
    {
        ...
        vectorLong.clear();
        vectorString.clear();
        comboBox.setModel(new DefaultComboBoxModel<String>(getLists()));
    }

    /**
     * @return
     */
    public static AddToExhibition getInstance()
    {
        return instance;
    }
    ...
    private void checkList(ArrayList<Outsourced> l) throws emptyList
    {
        if (l.isEmpty())
        {
            throw new emptyList("Keine Ausstellung vorhanden!");
        }
